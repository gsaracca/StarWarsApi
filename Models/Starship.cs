...
public sealed class Starship
{
    ...
    [JsonProperty("hyperdrive_rating")]      public string HyperdriveRating     { get; init; } = string.Empty;
    [JsonProperty("MGLT")]                   public string Mglt                 { get; init; } = string.Empty;
    [JsonProperty("starship_class")]         public string StarshipClass        { get; init; } = string.Empty;
